package com.eddy.jobqueue.callback;
...
public interface JobManagerCallback {
     ...
     * {@link com.eddy.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} while it was running.
     *
     * @see com.eddy.jobqueue.JobManager#cancelJobs(TagConstraint, String...)
     * @see com.eddy.jobqueue.JobManager#cancelJobsInBackground(CancelResult.AsyncCancelCallback, TagConstraint, String...)
     */
     ...
     *                         {@link com.eddy.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} request.
