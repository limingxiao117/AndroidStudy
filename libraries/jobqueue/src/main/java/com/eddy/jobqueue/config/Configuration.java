package com.eddy.jobqueue.config;
...
import com.eddy.jobqueue.DefaultQueueFactory;
import com.eddy.jobqueue.JobQueue;
import com.eddy.jobqueue.QueueFactory;
import com.eddy.jobqueue.di.DependencyInjector;
import com.eddy.jobqueue.log.CustomLogger;
import com.eddy.jobqueue.log.JqLog;
import com.eddy.jobqueue.network.NetworkUtil;
import com.eddy.jobqueue.network.NetworkUtilImpl;
import com.eddy.jobqueue.persistentQueue.sqlite.SqliteJobQueue;
import com.eddy.jobqueue.scheduling.Scheduler;
import com.eddy.jobqueue.timer.SystemTimer;
...
/**
 * {@link com.eddy.jobqueue.JobManager} configuration object
 */
...
public class Configuration {
    ...
    public static final class Builder {
         ...
         * {@link com.eddy.jobqueue.inMemoryQueue.SimpleInMemoryPriorityQueue}
         ...
         * {@link com.eddy.jobqueue.persistentQueue.sqlite.SqliteJobQueue.JavaSerializer}
         ...
         * {@link com.eddy.jobqueue.BatchingScheduler#DEFAULT_BATCHING_PERIOD_IN_MS} delay.
